    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mt-6 flex flex-col overflow-hidden rounded-xl bg-white shadow-xl lg:flex-row">
          <div className="hidden bg-indigo-600 px-6 py-8 text-white lg:flex lg:w-2/5 lg:flex-col lg:justify-center">
                  ...
                  {[
                    ...
                    <div key={id}>
                      ...
                      <input
                        ...
                        className={`
            mt-1 w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2 text-gray-800 
            placeholder-gray-400 transition-shadow duration-150
            focus:border-indigo-500 focus:bg-white focus:shadow-lg focus:outline-none
          ...
          `}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className={`
          mt-1 w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2 text-gray-800 placeholder-gray-400
          transition-shadow duration-150 focus:border-indigo-500 focus:bg-white focus:shadow-lg focus:outline-none
        ...
        `}
                  ...
                  <div className="md:col-span-2 relative" ref={dropdownRef}>
                    ...
                    <button
                      ...
                      className={`
          mt-1 flex w-full items-center justify-between rounded-xl border border-gray-300 bg-gray-50 px-4 py-2 text-gray-800
          transition-shadow duration-150 focus:outline-none focus:border-indigo-500 focus:shadow-lg
          ${errors.selectedCategories ? "border-red-500" : ""}
        `}
                    >
                      <span>
                    ...
                    <div key={id}>
                      ...
                      <div className="relative mt-1">
                        <input
                          ...
                          placeholder="••••••••"
                          className={`
              w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2 text-gray-800 placeholder-gray-400
              transition-shadow duration-150 focus:border-indigo-500 focus:bg-white focus:shadow-lg focus:outline-none
              ${errors[id] ? "border-red-500 focus:border-red-500" : ""}
            `}
                        />
                ...
                <button
                  type="submit"
                  className="w-full rounded-2xl bg-indigo-600 px-6 py-3 text-sm font-semibold text-white transition-colors duration-150 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 flex items-center justify-center"
                >
